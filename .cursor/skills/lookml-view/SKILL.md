...
## 1. File Organization & Editing Rules

**CRITICAL PROJECT RULES:**
1. **NO CHANGES** should ever be made to files in the `01_base/` directory.
2. **ALL ADDITIONS/UPDATES** to view files must be made as a refinement in the `02_standard/` directory.

-   **Base Views (Read-Only)**: `01_base/[view_name].view.lkml`
-   **Refined Views (Edit Here)**: `02_standard/[view_name].layer.lkml`
-   **Logical Explores**: `03_logical/[explore_name].explore.lkml`
