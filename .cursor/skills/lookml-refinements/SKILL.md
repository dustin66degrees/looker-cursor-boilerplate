...
### Structure
-   **File**: `03_logical/orders.explore.lkml`
-   **Content**:
    1.  `include` the necessary base and standard views needed for *this* explore (e.g. from `01_base/` and `02_standard/`).
    2.  Define `explore: orders { ... }`.
-   **Model File**: `models/my_model.model.lkml`
    -   `include: "/03_logical/orders.explore.lkml"`
...
**Refinement**: `02_standard/users.layer.lkml`
```lookml
