...
**CRITICAL PROJECT RULE:** Explores are ALWAYS established in a standalone file in the `03_logical/` directory (e.g., `03_logical/[explore_name].explore.lkml`) and included individually in the model file.
