...
3.  **Best Practices**:
    - **Includes**: Explores MUST be included individually from the `03_logical/` directory (e.g., `include: "/03_logical/orders.explore.lkml"`). Do NOT use wildcard includes like `include: "/*.view"` for models.
